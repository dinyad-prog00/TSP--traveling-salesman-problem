...
// descente
// Il prend en argument l'instance et la fonction de descente (algo) comme worst_improver_2opt, best_improver_swap, ...
typedef int *(*Algorithm)(Instance *, int *, int, Move *, int, int *); //Pointeur de fonction
